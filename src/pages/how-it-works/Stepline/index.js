                ...
                <Grid key={idx} ref={ref} container columns={{ xs: 12 }}>
                    ...
                    <Box mb={24}>
                      {idx % 2 !== 0 ? (
                        <Stack
                          ...
                          spacing={2}
                          className={
                            inView ? "fade-up fade-up-animate" : "fade-up"
                          }
                        >
                          <Typography
                            variant="body1"
                  ...
                  <Grid item xs="auto">
                    <Stack
                      direction="column"
                      mt={{ xs: 2.5, md: 25 }}
                      className={seen.includes(idx) ? "build-in" : "build-out"}
                      sx={{
                        transition:
                          "height 2s 0.4s cubic-bezier(0.16, 1, 0.3, 1)",
                      }}
                    >
                      <Box
                        position="relative"
                      ...
                      >
                        <Box
                          className={
                            seen.includes(idx) ? "fade-in" : "fade-out"
                          }
                        >
                          <Box
                            width={{ xs: 36, sm: 64, md: 80 }}
                            borderRadius={100}
                            bgcolor="accent.light"
                            top={{ xs: -18, sm: -32, md: -40 }}
                            sx={{
                              display: "grid",
                              placeItems: "center",
                              position: "absolute",
                    ...
                    <Box mb={24}>
                      {idx % 2 === 0 ? (
                        <Stack
                          ...
                          sx={{
                            visibility: idx % 2 === 1 ? "hidden" : "visible",
                          }}
                        >
                          <Typography
                            variant="body1"
                ...
                <Grid key={idx} ref={ref} container columns={{ xs: 12 }}>
                  ...
                  <Grid item xs alignSelf="center">
                    <Stack
                      ...
                      spacing={2}
                      mb={24}
                      className={inView ? "fade-up fade-up-animate" : "fade-up"}
                      sx={{
                        visibility: md
                          ? idx % 2 === 1
                            ? "hidden"
